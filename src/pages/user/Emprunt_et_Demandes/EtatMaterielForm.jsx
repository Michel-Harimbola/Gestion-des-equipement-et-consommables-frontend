    ...
    <div className="fixed inset-0  backdrop-blur-sm bg-black/40 flex items-center justify-center z-50">
      <div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-6 shadow-lg w-full sm:max-w-lg max-w-md">
        ...
        >
            ...
            >
                <option value="Neuf">{t("newCondition")}</option>
                <option value="BonEtat">{t("goodCondition")}</option>
                <option value="EtatMoyen">{t("averageCondition")}</option>
                <option value="MauvaisEtat">{t("badCondition")}</option>
                <option value="HorsUsage">{t("outOfService")}</option>
                <option value="EnReparation">{t("underRepair")}</option>
            </select>
            </div>

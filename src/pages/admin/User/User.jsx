...
export default function User() {
  ...
  const FilterUser = items.filter((user) => {
    if (isActive === "all") return true;
    return user.role === isActive;
  })
  ...
  return (
    <div className="h-screen pt-22 lg:pl-74 lg:pr-10 px-4">
          ...
          <div className="relative">
            ...
            {openFilter && (
              <div className="absolute bg-white dark:bg-gray-900 dark:text-white w-full border border-gray-500 border-t-0 border-b-0">
                {["all", "admin", "regisseurEquipementInterne", "personnelInterne", "partenaire"].map((val) => (
                  <div 
                    key={val}
        ...
        <div>
          <button
            ...
            className=" 
              ...
              bg-fuchsia hover:bg-red-400  dark:bg-fuchsia focus:outline-none focus:ring-2 focus:ring-offset-2 
              focus:ring-red-500 transition duration-150 shadow-md
            "       
          >
            ...
            <table className="min-w-full text-lg text-gray-700">
              ...
              <tbody>
                {FilterUser.map((user, index) => (
                  <tr 
                      key={user.id} 
                      className="even:bg-white odd:bg-gray-50 hover:bg-gray-100 dark:hover:bg-gray-700 dark:even:bg-gray-800 
